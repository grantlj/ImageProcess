function do_seg_single_image(im_org_path,im_shadow_path,feat_path)
    im1=imread(im_shadow_path);
    im1_t(:,:,1)=im1;im1_t(:,:,2)=im1;im1_t(:,:,3)=im1;
    im1=im1_t;
  ...
  % bbox=[x_min y_min x_max-x_min y_max-y_min];
   % im2 = insertObjectAnnotation(im2,'rectangle',bbox,'region');
   % imshow(im2);
