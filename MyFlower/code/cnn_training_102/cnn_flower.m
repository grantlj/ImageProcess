function [net, info] = cnn_flower(batchsize, usegpu)
...
opts.expDir = 'model';
opts.imdbPath ='dataset/oxfordflower102/imdb.mat';
opts.train.batchSize = batchsize ;
opts.train.numEpochs = 200 ;
opts.train.continue = true ;
opts.train.useGpu = usegpu ;
...
function [im, labels] = getBatch(imdb, batch)
 ...
 db_root_path='dataset/oxfordflower102/jpg/';
% --------------------------------------------------------------------
...
%get image mean and image labels.
  ...
  %  labels=zeros(1,flower_count);
    ...
    load('dataset/oxfordflower102/imagelabels.mat');
...
%get set.(trn,val,tst)
   load('dataset/oxfordflower102/setid.mat');
