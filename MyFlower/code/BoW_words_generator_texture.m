function [] = BoW_words_generator_texture()
 raw_feat_path='../dataset/raw_feat/';
 data_splits_path='../dataset/datasplits.mat';
 output_file_path='../dataset/texture_words_centers.mat';
 load(data_splits_path);
 
 img_count=1360;
 img_sample_count=500;
 
 feat_mat=rand(img_sample_count*img_count,8);
  ...
  disp('Doing Clusting...');
  [centers, assignments]=vl_kmeans(feat_mat', 700);
