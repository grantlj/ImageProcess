...
#ifndef __head_counter_release_lib_h
#define __head_counter_release_lib_h 1
...
#ifdef EXPORTING_head_counter_release_lib
#define PUBLIC_head_counter_release_lib_C_API __global
#else
#define PUBLIC_head_counter_release_lib_C_API /* No import statement needed. */
#endif

#define LIB_head_counter_release_lib_C_API PUBLIC_head_counter_release_lib_C_API

#elif defined(_HPUX_SOURCE)

#ifdef EXPORTING_head_counter_release_lib
#define PUBLIC_head_counter_release_lib_C_API __declspec(dllexport)
#else
#define PUBLIC_head_counter_release_lib_C_API __declspec(dllimport)
#endif
...
#define LIB_head_counter_release_lib_C_API
...
extern LIB_head_counter_release_lib_C_API 
...
#ifdef EXPORTING_head_counter_release_lib
#define PUBLIC_head_counter_release_lib_CPP_API __declspec(dllexport)
#else
#define PUBLIC_head_counter_release_lib_CPP_API __declspec(dllimport)
#endif

#define LIB_head_counter_release_lib_CPP_API PUBLIC_head_counter_release_lib_CPP_API

#else

#if !defined(LIB_head_counter_release_lib_CPP_API)
#if defined(LIB_head_counter_release_lib_C_API)
#define LIB_head_counter_release_lib_CPP_API LIB_head_counter_release_lib_C_API
#else
#define LIB_head_counter_release_lib_CPP_API /* empty! */ 
#endif
#endif
