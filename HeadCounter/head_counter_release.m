function [bdx_label_mat]=head_counter_release(img_path,bdx_path)
vl_setupnn;
...
%for img_count=1:50
   % bdx_gt_file=[bdx_gt_root_path,num2str(img_count),'.txt'];
    ...
    bdx_label_mat=importdata(bdx_path);
...
%     imshow(im_raw_2);
    ...
    for i=1:size(bdx_label_mat,1)
     ...
     out_bdx_file_name=[img_path,'-OUT.mat'];
     out_im_file_name=[img_path,'-OUT.jpg'];
