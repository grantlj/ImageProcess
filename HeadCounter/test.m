...
bdx_cnn_root_path='dataset/boundingbox_cnn03/';
figure_cnn_root_path='dataset/figure_cnn03/';
load('cnn_1024_naive_SVM_model.mat');
...
%     imshow(im_raw_2);
    ...
    for i=1:size(bdx_label_mat,1)
     ...
     out_bdx_file_name=[bdx_cnn_root_path,num2str(img_count),'.txt'];
     ...
     if (exist(out_bdx_file_name,'file'))
      ...
      tmp_feat=double(gather(res(20).x(:)'));
    ...
    bdx_label_mat=bdx_label_mat(cnn_bdx_index,:);
