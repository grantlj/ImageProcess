...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	*/
	...
	//cvNamedWindow("Example", CV_WINDOW_AUTOSIZE);//申请可以自动调节大小的窗口Example1
	CvCapture *capture = cvCreateFileCapture("D://test2.avi");//读取avi格式的影片
	IplImage*frame;
	while (1)
	{
		...
		IplImage* img1 = cvCreateImage(cvGetSize(frame), IPL_DEPTH_8U, 1);//创建目标图像  
