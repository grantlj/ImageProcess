function [extracted_feat]=getsift_for_bow_single_video(videoid,out_path)
 disp(['Now extracting SIFT for BoW:',num2str(videoid),'  under output path;',out_path]); 
 extracted_feat=[];
 featpath=[out_path,num2str(videoid),'-SIFT_RAW_Feature.mat'];
 load(featpath);
 ...
 disp(['Now handling:',num2str(videoid),'  SIFT extraction finished']); 
