...
private:
	...
	CvSeq* scale_space_extrema( IplImage***, int, int, double, int, CvMemStorage*, IplImage*** );  // [ feature detection from DoG]
	...
	void compute_descriptors( CvSeq*, IplImage***, int, int, IplImage*** );            // [ compute descriptor ]
	...
	double*** motion_descr_hist( int, int, double, double, int, int, IplImage*, int, int );    // [ motion descriptor ]
	int calc_motion_mag_ori( int, int, double*, double*, IplImage*, int );                // [ calculate mag and oritation of motion ]
