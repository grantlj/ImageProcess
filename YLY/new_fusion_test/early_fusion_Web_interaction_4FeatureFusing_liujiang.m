...
%         save(['/data/collegestudent/liujiang/YLY/new_fusion_test/storage/',char(cellstr(experi_folder(experi_num))),'+STIP+SIFT+MoSIFT','/model',int2str(test_fold),'.mat'],'model'); %保存model用于单独某部分样本的识别AP检测   %/data/collegestudent/liujiang/YLY/new_fusion_test/storage is the path that you store the results
        model = [];
    end
