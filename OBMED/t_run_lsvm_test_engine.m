function []=t_run_lsvm_test_engine(test_object,model_folder)
   ...
   % clear all;
    ...
    % load('lsvm_rand_row.mat');    %load rand row info.
     load(['/home/liujiang/',test_object,'_train_set.mat']);     %load test set.
    ...
    for i=0:modelcount
      ...
      [acc(i+1),fval]=t_lsvm_test_engine(i,train_set,test_object,word,model_folder);
