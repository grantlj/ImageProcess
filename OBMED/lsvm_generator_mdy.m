...
for itecount=1:100   %begin iteration. maximum iteration count is 100.
    ...
    if (itecount==1)
        save(['lsvm_model_mdy/',test_object,'_1vN_Models_After_ITE_0.mat'],'model');  %save default mean-pooling strategy for comparable test.
    end
    
    %Step 2: Update theata using w,b in step 1.
    model=lsvm_update_theta(train_set,model);
    save(['lsvm_model_mdy/',test_object,'_1vN_Models_After_ITE_',num2str(itecount),'.mat'],'model');
end
