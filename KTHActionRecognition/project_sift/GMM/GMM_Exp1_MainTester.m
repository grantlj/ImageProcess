...
fileNameRoot='GMM_Exp1_GenerateModel_';
path='hist_testSet/';
...
%                       prob=normpdf(v2,v1,models{classes}.cov(:,gmms)')*models{classes}.priors(gmms);
%                       if (prob>maxprob)
%                           maxprob=prob;
%                           flag=classes;
%                       end
